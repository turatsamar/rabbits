...
class _Activity extends State<Activity> with SingleTickerProviderStateMixin {
  ...
  final Stream<QuerySnapshot> cleaningStream = FirebaseFirestore.instance
      .collection('cleaning')
      .orderBy('date', descending: true)
      .snapshots();
  ...
  static const List<Tab> tabs = [
    ...
    Tab(icon: Icon(Icons.cleaning_services_rounded)),
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (!snapshot.hasData) {
          ...
          return ListView(
            ...
            Widget trailing = data.containsKey('money_amount') ? Text(data['money_amount'], style: style) : Text('');
    ...
    return Scaffold(
        ...
        body: new TabBarView(
          ...
          children: [
            ...
            getHistory(cleaning, cleaningStream),
